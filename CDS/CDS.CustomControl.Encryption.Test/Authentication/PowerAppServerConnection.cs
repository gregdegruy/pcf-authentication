...
{
    internal class PowerAppServerConnection : ServerConnection
    {        
        enum Regions
        {
            UnitedStates,
        ...
        private PowerAppServerConfiguration configuration;
        const string partialDiscoveryUri = "/XRMServices/2011/Discovery.svc";

        public PowerAppServerConnection(string serverAddress, string username, string password)
        {
            configuration = new PowerAppServerConfiguration();
        ...
        public static OrganizationServiceProxy GetOrganizationProxy(
            PowerAppServerConfiguration serverConfiguration)
        {
        ...
        public PowerAppServerConfiguration GetServerConfiguration()
        {
            bool IsO365Org = true;
            if (IsO365Org)
            {
        ...
        private DiscoveryServiceProxy GetDiscoveryProxy()
        {
            ...
            catch (System.ServiceModel.Security.ExpiredSecurityTokenException ex) { }
        ...
        public static TProxy GetProxy<TService, TProxy>(PowerAppServerConfiguration currentConfig)
            ...
            where TProxy : ServiceProxy<TService>
        {
            ...
            Uri serviceUri = isOrgServiceRequest ?
                currentConfig.OrganizationUri : new Uri("https://disco.crm.dynamics.com/XRMServices/2011/Discovery.svc");

            IServiceManagement<TService> serviceManagement = null;
            try
            {
               serviceManagement =
        ...
        /// <returns></returns>
        public static ClientCredentials GetUserLogonCredentials(PowerAppServerConfiguration config)
        {
